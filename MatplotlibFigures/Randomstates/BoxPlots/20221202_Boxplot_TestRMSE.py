...
plt.savefig("D:/Benutzerdateien/OneDrive - tuhh.de/TUHH/Semester 9/Studienarbeit/LateX/08_validation/fig/Errors/Boxplot/BoxplotTestRMSE.pdf", format='pdf',bbox_inches='tight') # saved as eps for high quality pictures

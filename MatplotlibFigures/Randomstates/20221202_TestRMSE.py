...
RMSEListbm=idbm['RMSE'].tolist()
RMSEListsm=idsm['RMSE'].tolist()
RMSEListfs=idfs['RMSE'].tolist()
# MAPEList=idbm['MAPE'].tolist()
# MSEList=idbm['MSE'].tolist()

print("Liste FS",RMSEListfs)
...
# plt.hlines(RMSEbmav, 180000, (lis[-1]+60000), color='black', linestyle='--',label='Averages')
...
plt.savefig("D:/Benutzerdateien/OneDrive - tuhh.de/TUHH/Semester 9/Studienarbeit/LateX/08_validation/fig/Errors/TestRMSE.pdf", format='pdf',bbox_inches='tight') # saved as eps for high quality pictures
